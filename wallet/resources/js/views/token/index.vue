    ...
    <div class="flex w-full mb-4 bg-white flex-wrap">
        <div class="flex w-full h-12 m-4">
            <div class="w-11/12 flex-none p-2">
                <h2 class="justify-start">Generar Token</h2>
            </div>
        </div>
        <div class="w-full h-12">
            <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" @submit.prevent="store">
                ...
                <div class="mb-4">
                    ...
                    <input type="number" v-model="create.email" class="shadow appearance-none border rounded w-9/12 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
...
<script>
import CREATE_TOKEN from "../../graphql/token/token.graphql";
